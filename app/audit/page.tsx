      ...
      <div className="max-w-3xl mx-auto space-y-16">
        ...
        <div className="max-w-xl space-y-2">
          ...
          <p className="text-xs md:text-sm mt-5 text-zinc-400 font-light tracking-wide leading-relaxed">
            Technical debt is the silent killer of scale. We identify
            bottlenecks and engineer the path to 10x throughput. Book your
            FREE 15-minute diagnostic session below.
          </p>
        </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            {
              title: "Latency Audit",
              desc: "Precise identification of query-timeout roots and inefficient data pathways.",
            },
            {
              title: "Resilience Test",
              desc: "Stress-testing your modular foundations against unexpected traffic spikes.",
            },
            {
              title: "Scaling Roadmap",
              desc: "Architectural blueprint tailored for your next enterprise-level growth phase.",
            },
          ].map((item, i) => (
            <div
              key={i}
            ...
            >
              <h3 className="text-[12px] uppercase tracking-[0.3em] font-bold text-zinc-200 mb-3">
                {item.title}
              </h3>
        ...
        <section className="group relative bg-zinc-950/30 border border-zinc-900 p-1 transition-all duration-500 hover:border-zinc-700">
          <div className="p-8 border-b border-zinc-900 flex justify-between items-center bg-black/50">
            <h3 className="text-[12px] uppercase tracking-[0.3em] font-bold text-zinc-400">
